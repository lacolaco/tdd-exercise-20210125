...
- [ ] 製品を購入する契約を作成できる
  - [x] 契約は1つの製品を1つだけ購入できる
    - [x] 種類「ワードプロセッサ」の製品「MS Word」18,800 円を購入する契約を作成できる
    - [x] 種類「スプレッドシート」の製品「MS Excel」27,800 円を購入する契約を作成できる
    - [x] 種類「データベース」の製品「MS SQL Server」919,000 円を購入する契約を作成できる
  - [ ] 契約は 1 つの製品と契約日をもつ
